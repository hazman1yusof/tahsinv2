<div class="ui fixed top menu sidemenu" id="sidemenu_topmenu" style="z-index: 5000;">
    ...
    <div class="right menu">
        ...
        <span class="himsg">{{Auth::user()->username}}ssssssssssssss<i class="dropdown icon"></i></span>
          <div class="menu">
...
<div class="ui sidebar inverted vertical menu sidemenu">
    ...
    <a class="item @if(Request::is('kelas')) {{'active'}} @endif" href="{{ url('/kelas')}}"><i style="float: left" class="big chalkboard teacher icon"></i>Kelas</a>
    <div class="item">
